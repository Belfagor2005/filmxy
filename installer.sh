...
# wget https://github.com/Belfagor2005/filmxy/archive/refs/heads/main.tar.gz
wget --no-check-certificate --no-cache --no-dns-cache 'https://github.com/Belfagor2005/filmxy/archive/refs/heads/main.tar.gz'
tar -xzf main.tar.gz
cp -r 'filmxy-main/usr' '/'
set +e
cd
sleep 2
...
echo ""
echo "#########################################################"
echo "#        filmxy Stream Live INSTALLED SUCCESSFULLY      #"
